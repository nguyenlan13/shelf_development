...
hgsp = Article.create(title: "Claude Shannon: How a Genius Solves Problems", year: 2018, source: "https://link.medium.com/YxUPCOPr8Y", author: zr)
...
FaveQuote.create(user: lan, quote: "It’s easy for our brain to get stuck in mental loops, and the best way to break these mental loops is to change the reference point. We are not changing our intuitive understanding of the problem or the core we have identified, just how it is expressed.", quotable: hgsp)
FaveQuote.create(user: lan, quote: "If you don't sacrifice for what you want, what you want becomes the sacrifice.", quotable: op)
FaveQuote.create(user: lan, quote: "Habits are the compound interest of self improvement.", quotable: ah)
FaveQuote.create(user: lan, quote: "In order to feel less judged, judge less.", quotable: op)
